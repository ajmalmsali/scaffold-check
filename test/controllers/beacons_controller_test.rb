...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { building_id: @beacon.building_id, identifier: @beacon.identifier, prox_max: @beacon.prox_max, prox_med: @beacon.prox_med, prox_min: @beacon.prox_min }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { building_id: @beacon.building_id, identifier: @beacon.identifier, prox_max: @beacon.prox_max, prox_med: @beacon.prox_med, prox_min: @beacon.prox_min }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
